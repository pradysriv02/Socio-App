    ...
    return(
        ...
        >
                        ...
                        {chats.map((chat) => {
                            return(
                                <div onClick={() => setCurrentChats(chat)}>
                                    <Conversation chatData={chat} currentUserId={userId} online={checkOnlineStatus(chat)} />
                                </div>
                            );
                        })}
                    </Box>
            ...
            <Box display="grid" gridTemplateColumns="100% auto">
                    <Box >
                       <ChatBox chatData={currentChats} currentUser={userId} setSendMessage={setSendMessage} recievedMessage={recievedMessage}/>
                    </Box>
            </Box>
        </Box>
